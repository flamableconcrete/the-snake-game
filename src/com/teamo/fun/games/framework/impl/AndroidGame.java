...
import com.teamo.fun.games.framework.Audio;
...
import com.teamo.fun.games.framework.Input;
...
public abstract class AndroidGame extends Activity implements Game {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// int frameBufferWidth = isLandscape ? 480 : 320; // OLD STUFF THAT DOESN'T WORK!!!!!!!!!!!!!!
		// int frameBufferHeight = isLandscape ? 320 : 480; // OLD STUFF THAT DOESN'T WORK!!!!!!!!!!!!!!
